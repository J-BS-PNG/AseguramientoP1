...
router.get("/get-horarios-dia/:cedula_funcionario/:dia", token.verifyToken, consultaFuncionarioController.getHorariosFuncionarioDia);
router.get("/get-horarios/:cedula_funcionario", token.verifyToken, consultaFuncionarioController.getHorariosFuncionario);
