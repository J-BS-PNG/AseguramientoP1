...
router.get("/get-horarios-from/:mongo_id", token.verifyToken, consultaParqueosController.getHorariosParqueo);
router.get("/get-espacios-from-tipo/:mongo_id/:tipo", token.verifyToken, consultaParqueosController.getEspaciosParqueoTipo);
